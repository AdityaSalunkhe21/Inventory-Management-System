...
describe('Stock Quantity API Tests', () => {
    ...
    describe('PATCH /:id/increase-stock-quantity', () => {
        it('should increase stock quantity with valid id and quantity', async () => {
            const response = await request(app)
                .patch(`/products/${testProductId}/increase-stock-quantity`)
                .send({ quantity: 5 })
                .expect(200);
        ...
        it('should return 404 for non-existent product id', async () => {
            const response = await request(app)
                .patch(`/products/${nonExistentId}/increase-stock-quantity`)
                .send({ quantity: 5 })
                .expect(404);
        ...
        it('should return 400 for invalid product id parameter', async () => {
            const response = await request(app)
                .patch('/products/invalid-id/increase-stock-quantity')
                .send({ quantity: 5 })
                .expect(400);
        ...
        it('should return 400 for negative product id', async () => {
            const response = await request(app)
                .patch('/products/-1/increase-stock-quantity')
                .send({ quantity: 5 })
                .expect(400);
    ...
    describe('PATCH /:id/decrease-stock-quantity', () => {
        it('should decrease stock quantity with valid id and quantity', async () => {
            const response = await request(app)
                .patch(`/products/${testProductId}/decrease-stock-quantity`)
                .send({ quantity: 3 })
                .expect(200);
        ...
        it('should return 404 for non-existent product id', async () => {
            const response = await request(app)
                .patch(`/products/${nonExistentId}/decrease-stock-quantity`)
                .send({ quantity: 5 })
                .expect(404);
        ...
        it('should return 400 for invalid product id parameter', async () => {
            const response = await request(app)
                .patch('/products/invalid-id/decrease-stock-quantity')
                .send({ quantity: 5 })
                .expect(400);
        ...
        it('should return 400 for negative product id', async () => {
            const response = await request(app)
                .patch('/products/-1/decrease-stock-quantity')
                .send({ quantity: 5 })
                .expect(400);
